...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/litecoinfinance/btcd/chaincfg)
...
```bash
$ go get -u github.com/litecoinfinance/btcd/chaincfg
```
